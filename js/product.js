$(function () {
  ...
  $(document).on('click', '.product__btn-favourite', function () {
    $(this).toggleClass('product__btn-favourite--active');
  });
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var videos = document.querySelectorAll('.product__comp--video');
